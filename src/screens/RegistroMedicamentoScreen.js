...
const handleSaveMedication = () => {
  ...
  setMedicationsByDay(prev => {
    ...
    if (useOption === "diasDaSemana") {
      // Adiciona o medicamento em todos os dias da semana marcados
      selectedDays.forEach(dayIndex => {
        // cria uma lista de todos os dias do mês que correspondem àquele dia da semana
        for (let i = 1; i <= 31; i++) {
      ...
      // adiciona medicamento dentro do intervalo de datas escolhido
...
mascote: {widht: 180, height: 180, marginBottom: 20, marginTop: -80}
});